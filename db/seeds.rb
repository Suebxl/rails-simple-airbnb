...
Flat.create(
  name: 'Two Bedroom Flat with Balcony in Central Wimbledon',
  address: '93 The Broadway, Wimbledon, London',
  description: 'A stunning two bedroom, two bathroom luxury apartment set in a prestigious modern development near all the amenities of Wimbledon town centre.',
  price_per_night: 195,
  number_of_guests: 4,
  picture_url:"https://unsplash.com/photos/syhl9e4igVs"
)
